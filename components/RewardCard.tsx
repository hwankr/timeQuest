// 보상 카드 컴포넌트 — 개별 보상 아이템 표시 및 구매 버튼 (포인트 부족 시 shake)
...
export const RewardCard = React.memo(
  function RewardCard({
    ...
    const handleBuyPress = useCallback(() => {
      ...
      onBuy(reward);
    }, [insufficientPoints, reward, onBuy]);
        ...
        >
          ...
          {showCustomBadge && (
            <View style={[styles.customBadge, { backgroundColor: colors.primary }]}>
              <Text style={[styles.customBadgeText, { color: colors.surface }]}>커스텀</Text>
            </View>
          )}
          ...
          <View style={styles.infoContainer}>
            ...
            <View style={styles.costRow}>
              ...
              <Text style={[styles.cost, { color: colors.pointDark }]}>{reward.cost.toLocaleString()}</Text>
            </View>
          </View>
